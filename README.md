...
**Via Claude Code Plugin (recommended — supports auto-update):**

```
/plugin marketplace add kennyzheng-builds/agentslink
```
...
> Install the AgentsLink skill from https://agentslink.link/install and save to ~/.claude/skills/agents-link/SKILL.md
